<?php
//define your token
define("TOKEN", "fundream");//改成自己的TOKEN
define('APP_ID', 'wxbed4b340ce2e62b0');//改成自己的APPID
...
class wechatCallbackapiTest
{
    ...
    {
        $this->responseMsg();
        $arr[]= "您好，这是自动回复，有事请留言，我会尽快回复你的^_^";
